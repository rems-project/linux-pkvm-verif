...
/*
virt:0x0000000131006000 virt':0x0000000131007000 phys:0x0000000131006000 size:0x00000001 -R-X HYP_IDMAP          hyp_symbol_addr(__hyp_idmap_text_start)
virt:0x00006000027c0000 virt':0x00006000027ed000 phys:0x000000013e002000 size:0x0000002d -RW- HYP_VMEMMAP_MAP    vmemmap
virt:0x00008000c090c000 virt':0x00008000c090d000 phys:0x000000010090c000 size:0x00000001 -RW- HYP_PERCPU         cpu:0x0000000000000000 per-cpu variables
virt:0x00008000c090d000 virt':0x00008000c090e000 phys:0x000000010090d000 size:0x00000001 -RW- HYP_PERCPU         cpu:0x0000000000000001 per-cpu variables
virt:0x00008000f1006000 virt':0x00008000f1018000 phys:0x0000000131006000 size:0x00000012 -R-X HYP_TEXT           hyp_symbol_addr(__hyp_text_start)
virt:0x00008000f1020000 virt':0x00008000f1789000 phys:0x0000000131020000 size:0x00000769 -R-- HYP_RODATA         hyp_symbol_addr(__start_rodata)
virt:0x00008000f200a000 virt':0x00008000f200b000 phys:0x000000013200a000 size:0x00000001 -R-- HYP_RODATA2        hyp_symbol_addr(__hyp_data_ro_after_init_start)
virt:0x00008000f200b000 virt':0x00008000f24a5000 phys:0x000000013200b000 size:0x0000049a -RW- HYP_BSS            hyp_symbol_addr(__bss_start)
virt:0x00008000f24a5000 virt':0x00008000f2527000 phys:0x00000001324a5000 size:0x00000082 -R-- HYP_BSS2           hyp_symbol_addr(__hyp_bss_end)
virt:0x00008000fe000000 virt':0x00008000fe002000 phys:0x000000013e000000 size:0x00000002 -RW- HYP_STACKS         hyp stacks
virt:0x00008000fe002000 virt':0x00008000fe02f000 phys:0x000000013e002000 size:0x0000002d -RW- HYP_VMEMMAP        vmemmap
virt:0x00008000fe02f000 virt':0x00008000feab0000 phys:0x000000013e02f000 size:0x00000a81 -RW- HYP_S1_PGTABLE     s1 pgtable
virt:0x00008000feab0000 virt':0x00008000ff33e000 phys:0x000000013eab0000 size:0x0000088e -RW- HYP_S2_MEM_PGTABLE s2 mem pgtable
virt:0x00008000ff33e000 virt':0x00008000ff541000 phys:0x000000013f33e000 size:0x00000203 -RW- HYP_S2_DEV_PGTABLE s2 dev pgtable
virt:0x00008000ff541000 virt':0x00008000ff643000 phys:0x000000013f541000 size:0x00000102 -RW- HYP_WORKSPACE      workspace
...
void _record_hyp_mappings(struct mappings *mappings, phys_addr_t phys, uint64_t size, uint64_t nr_cpus, unsigned long *per_cpu_base)
{
	...
	extend_mappings_virt(mappings, HYP_S1_PGTABLE, DUMMY_CPU, "s1 pgtable",
			...
			PAGE_HYP);
	extend_mappings_virt(mappings, HYP_S2_MEM_PGTABLE, DUMMY_CPU, "s2 mem pgtable",
			host_s2_mem_pgt_base,
			host_s2_mem_pgt_base + PAGE_SIZE*host_s2_mem_pgt_size,
			PAGE_HYP);
	extend_mappings_virt(mappings, HYP_S2_DEV_PGTABLE, DUMMY_CPU, "s2 dev pgtable",
			host_s2_dev_pgt_base,
			host_s2_dev_pgt_base + PAGE_SIZE*host_s2_dev_pgt_size,
			PAGE_HYP);
